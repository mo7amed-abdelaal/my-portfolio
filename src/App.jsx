...
const content = {
  ...
  ar: {
    ...
    projects: { heading: "مختارات من الأعمال", list: [ { title: "منصة استخبارات التهديدات (قيد التنفيذ)", desc: "تصميم TIP يجمع مصادر OSINT ويربط مؤشرات الاختراق ويوفر لوحة تحكم وواجهة API آمنة.", tech: ["Next.js", "FastAPI", "PostgreSQL", "Redis", "Docker"], link: "#", image: "/project1.png" }, { title: "أداة تحليل الرسوم (Qt GUI)", desc: "تطبيق GUI لحساب MST وأقصر مسار باستخدام Prim/Kruskal/Dijkstra. قادت فريقًا من 4 طلاب وأنجز المشروع بدرجة A+.", tech: ["Qt", "C++"], link: "#", image: "/project2.png" }, { title: "مشاريع C++ CLI", desc: "لعبة Snake ونظام إدارة السيارات باستخدام مبادئ OOP وتخزين الملفات.", tech: ["C++", "Raylib"], link: "#", image: "/project3.png" } ] },
